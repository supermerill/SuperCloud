...
namespace supercloud {
	...
	public:
		...
		ChunkAvailabilityRequest readChunkAvailabilityRequest(ByteBuff& buffer) const;
		// send my synch db
		...
		ChunkAvailabilityAnswer readChunkAvailabilityAnswer(ByteBuff& buffer) const;
		...
		ChunkReachableRequest readChunkReachableRequest(ByteBuff& buffer) const;
		ByteBuff writeChunkReachableAnswer(const ChunkReachableAnswer& answer) const;
		ChunkReachableAnswer readChunkReachableAnswer(ByteBuff& buffer) const;
		...
		SingleChunkRequest readSingleChunkRequest(ByteBuff& buffer) const;
		...
		SingleChunkAnswer readSingleChunkAnswer(ByteBuff& buffer) const;
